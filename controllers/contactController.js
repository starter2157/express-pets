...
exports.submitContact = async function(req, res, next) {
    ...
    try {
        const promise1 = transport.sendMail({
            ...
            <p>We appreciate in your interest in ${doesPetExist.name} and one of our staff members will reach out to you shortly! Below is a copy of the message you sent us for your personal records:</p>
